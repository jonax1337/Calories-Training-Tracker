...
import { getFoodDataByBarcode } from '../services/barcodeService';
import { saveFoodItem, getDailyLogByDate, saveDailyLog } from '../services/storageService';
import generateSimpleId from '../utils/idGenerator';
import { formatToLocalISODate, getTodayFormatted, dateToMySQLDateTime } from '../utils/dateUtils';
import { determineDisplayUnit, getDisplayUnitString, getShortUnitString } from '../utils/unitUtils';
import { useTheme } from '../theme/ThemeContext';
import { useSafeAreaInsets } from 'react-native-safe-area-context';
import { createFoodDetailStyles } from '../styles/screens/FoodDetailStyles';
import * as Haptics from 'expo-haptics';
import { sendSoundCommand } from '../components/webview/SoundWebView';
